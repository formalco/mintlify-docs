...
<img src="/img/logs.png" alt="Formal logs dashboard" />
...
<Tabs>
  ...
  <Tab title="Aggregation Mode">
    **Advanced analytics** with grouping and visualization. - Group by
    ...
    anomalies
    <img src="/img/logs_aggregation.png" alt="Logs aggregation view" />
  </Tab>
</Tabs>
...
<img src="/img/logs_side_panel.png" alt="Log details panel" />
...
<img src="/img/quick_actions.png" alt="Quick actions menu" />
...
See [Sessions](/docs/guides/core-concepts/sessions) for more details on session recordings.
