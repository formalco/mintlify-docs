...
description: "Learn about Formal's AI-powered Privileged Access Management solution for modern data-driven organizations"
---
...
<CardGroup cols={2}>
  <Card
    ...
    icon="database"
    href="/adding-resource/introduction"
  >
  ...
  <Card
    ...
    icon="server"
    href="/deploying-a-connector/introduction"
  >
