...
<AccordionGroup>
  <Accordion icon="copy" title="Clone your docs locally">
    ...
    repository in your [dashboard](https://app.joinformal.com). To clone the
...
<AccordionGroup>
  <Accordion icon="github" title="Install our GitHub app">
    Install the Mintlify GitHub app from your [dashboard](https://app.joinformal.com/settings/organization/github-app).
