...
<CardGroup cols={2}>
  <Card
    ...
    icon="shield-check"
    href="/security/policies/introduction"
  >
...
<Card
  ...
  icon="route"
  href="/using-formal-connector/smart-routing"
>
  Route to multiple databases through a single listener
</Card>

{" "}
<Card title="View Audit Logs" icon="file-lines" href="/security/logs">
  ...
  <Card
    ...
    icon="eye-slash"
    href="/security/policies/data-masking"
  >
...
<Note>
  ...
  deployment guides](/deploying-a-connector/introduction).
</Note>
