...
<Accordion title="Match Privacy to Need" icon="balance-scale">
  Use appropriate masking levels. Nullify for maximum privacy, partial redaction
  when some context is needed.
</Accordion>

<Accordion title="Test Masking" icon="flask">
  Use dry-run mode to verify masking works correctly before activating policies.
</Accordion>
