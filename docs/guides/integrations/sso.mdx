...
<Tip>
By default, Formal enforces JIT (Just-In-Time) provisioning. Users from allowed domains sign in with SSO: Formal automatically creates a user account on first login
Reach out to Formal support if you would like to disable JIT for your organization.
</Tip>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="arrows-rotate"
    href="/docs/guides/integrations/scim"
  >
