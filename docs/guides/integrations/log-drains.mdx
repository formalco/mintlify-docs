...
<img src="/img/supported_logs.png" alt="Supported log destinations" />
...
<AccordionGroup>
  ...
  <Accordion title="Access Controls" icon="lock">
    Restrict access to log data—it contains sensitive queries and potentially
    PII.
  </Accordion>

  <Accordion title="Alerting" icon="bell">
    Set up alerts in your SIEM for policy violations, failed authentications,
