...
The Connector sits between users and your databases, APIs, Kubernetes clusters, and other resources. It intercepts every connection, enforces access policies, logs all activity, and can mask sensitive data—without requiring changes to your applications.

_Also known as: Formal Gateway, Proxy_
