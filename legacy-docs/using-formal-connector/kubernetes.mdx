...
<Warning>
  The Kubernetes Resource name **must match exactly** with either the context
  name in your kubeconfig, or the AWS EKS cluster name.
</Warning>
...
<img src="../assets/images/eks_recording.png" className="rounded-lg" />
